...
class Course extends Model
{
    ...
    {
        return $this->hasMany(Notice::class, 'course_id', 'id')->select('id', 'course_id' , 'title' , 'description', DB::raw('DATE_FORMAT(notices.created_at, "%D %b %Y") as date'),  DB::raw('TIME_FORMAT(notices.created_at, "%h:%i %p") as time'), 'button', 'button_text', 'button_url');
    }
