    ...
    <main>
        <section class="dashboad tork-d-flex">
            <div class="left_sidebar">
             <dashboard-navs v-if="!['print_result'].includes($route.name)"></dashboard-navs>
            </div>
                    ...
                    <div class="tork-row">
                        <div class="tork-col-lg-10">
                            ...
                            <div class="previews_result">
                                ...
                                <div class="tork-card result_items" id="print">
                                    <!-- item one -->
                                    ...
                                    <div class="result_item tork-d-flex" v-for="(all_result,index) in all_results">
                                       ...
                                       <table class="table" >
                                            ...
                                            <button @click="makePDF" class="print-none">Print</button>
